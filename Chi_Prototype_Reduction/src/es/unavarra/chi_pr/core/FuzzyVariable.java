...
public class FuzzyVariable extends Variable {
	...
	public static final int TYPE_REAL = 0, TYPE_INTEGER = 1;
    ...
    /**
     * Type of values (integer or real)
     */
    private int valuesType;
     ...
     * @param valuesType type of values (real (TYPE_REAL) or integer(TYPE_INTEGER))
     */
    public void buildFuzzySets (double lowerLimit, double upperLimit, byte numLinguisticLabels, int valuesType){
